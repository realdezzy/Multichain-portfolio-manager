...
//import images 
import logo_square_withtext from '../../assets/images/galaxy/Genio_word.png'
                                ...
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    <div>
                                        <Link to="/" className="d-inline-block auth-logo">
                                            <img src={logo_square_withtext} alt="" height="100px" width='100px' />
                                        </Link>
                                    </div>
                                </div>
                            </Col>
                                ...
                                <Card className="mt-4">
                                    ...
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Get your free Genio account now</p>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Genio 
